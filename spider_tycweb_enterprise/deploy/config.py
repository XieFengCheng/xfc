...
with open(_config_file, 'r', encoding='utf-8') as f:
    ...
    # redis
    REDIS_HOST = _config_info['REDIS']['REDIS_HOST'] or REDIS_HOST
    REDIS_PORT = _config_info['REDIS']['REDIS_PROT'] or REDIS_PROT
    REDIS_PD = _config_info['REDIS']['REDIS_PD'] or REDIS_PD