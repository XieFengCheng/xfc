...
class HuXiu(object):
    def __init__(self):
        ...
        self.driver = webdriver.Firefox(executable_path=r"C:\geckodriver.exe", options=chrome_option)
    ...
    def move_x(self, distance):
        ...
        print(f'Cookies : {cook}')
        tyc_cookies.lpush('tyc_cookies', cook)
    ...
    def visit_index(self):
        ...
        # pwd_login.click()
        # time.sleep(3)
        # phone = self.driver.find_element_by_xpath("//form[@id='TYC-login']/div[@class='pb24 position-rel']"
        #                                           "/div[@class='live-search-wrap']/input["
        #                                           "@class='input contactphone js-live-search-phone']")
        # # phone.send_keys("18665821384")
        # phone.send_keys(self.login_user)
        # time.sleep(1)
        # pwd = self.driver.find_element_by_xpath("//form[@id='TYC-login']/div[@class='input-warp -block']/input"
        #                                         "[@class='input contactword input-pwd']")
        # # pwd.send_keys("tl123456")
        # pwd.send_keys(self.login_password)
